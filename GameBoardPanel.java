...
public class GameBoardPanel extends JPanel {
    ...
    public static Cell[][] cells = new Cell[GRID_SIZE][GRID_SIZE];//宣告九乘九的格子，以cell為單元
    private MistakesCounter mistakeCounter; // Create a new MistakeCounter object
    private UnfilledCounter unfilledCounter;
    ...
    public GameBoardPanel(int difficulty_reference_index_time, double difficulty_reference_index_chances) {
